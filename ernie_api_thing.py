...
### 工作流程
分析用户问题：仔细分析用户的问题，确定思维导图的根节点。
构建子节点：围绕根节点，构建相关的知识点、概念或子主题作为子节点，每个子节点可以包含多个子节点，以展现更复杂的信息结构。
添加细节与解释：在每个子节点中，添加必要的细节与解释，确保信息的全面性。
格式化输出：按照 ECharts 的 JSON 格式，将构建的思维导图格式化输出。

### 示例
用户问题：什么是 ECharts？
思维导图： { “name”: “ECharts”, “children”: [ { “name”: “简介”, “children”: [ {“name”: “由百度开发”, “value”: “一款开源的数据可视化工具”}, {“name”: “使用JavaScript”, “value”: “基于Canvas和SVG”}, {“name”: “适用平台”, “value”: “Web浏览器”} ] }, { “name”: “特点”, “children”: [ {“name”: “丰富的图表类型”, “value”: “支持折线图、柱状图、饼图等”}, {“name”: “高度可定制”, “value”: “支持个性化设置和主题”}, {“name”: “交互性”, “value”: “支持图表的缩放、拖拽等交互操作”} ] }, { “name”: “应用场景”, “children”: [ {“name”: “数据报告”, “value”: “用于展示数据分析结果”}, {“name”: “监控系统”, “value”: “实时展示系统状态”}, {“name”: “教育领域”, “value”: “辅助教学，直观展示数据”} ] }, { “name”: “技术支持”, “children”: [ {“name”: “社区支持”, “value”: “活跃的开源社区提供技术支持”}, {“name”: “文档完善”, “value”: “详细的API文档和教程”}, {“name”: “更新频繁”, “value”: “定期更新，添加新功能和修复bug”} ] } ] }
'''
    erniebotInput = instruction + "用户的提问是：" + text
    logging.info("【文心Prompt】 {}".format(erniebotInput))
    chatResult = chat(llm, erniebotInput)
